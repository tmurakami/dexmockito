...
final class DexMockitoMockMakerHelperFactory {

    private DexMockitoMockMakerHelperFactory() {
        throw new AssertionError("Do not instantiate");
    }

    static DexMockitoMockMakerHelper newDexMockitoMockMakerHelper() {
    ...
    private static File getCacheDir() {
        ...
        if (property.length() > 0) {
            ...
            return CacheDir.get(new File("/"), DexMockitoMockMaker.class.getClassLoader());
        }
    }
